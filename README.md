...
| Raspberry Pi 2B (1 GB RAM, armv7 32-bit) | Tier 0 only — BM25 keyword search, no Docker/Ollama (see [docs/PI2B_FEASIBILITY.md](PI2B_FEASIBILITY.md)) | <1s (search only, no generation) |
